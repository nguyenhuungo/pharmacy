...
@Data
@NoArgsConstructor
public class AdminDetails implements SimpleUserDetails, CredentialsContainer, Serializable {
    ...
    public AdminDetails(Long id, String username, String password, Collection<? extends GrantedAuthority> authorities, String email) {
        this(id, username, password, authorities, true, true, true, true, email);
    }

    public AdminDetails(Long id, String username, String password, Collection<? extends GrantedAuthority> authorities,
